...
import type { MessageList as _MessagePackage_MessageList, MessageList__Output as _MessagePackage_MessageList__Output } from '../MessagePackage/MessageList';
...
export interface MessageClient extends grpc.Client {
  ...
  Read(argument: _MessagePackage_ReadRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  Read(argument: _MessagePackage_ReadRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  Read(argument: _MessagePackage_ReadRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  Read(argument: _MessagePackage_ReadRequest, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  read(argument: _MessagePackage_ReadRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  read(argument: _MessagePackage_ReadRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  read(argument: _MessagePackage_ReadRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
  read(argument: _MessagePackage_ReadRequest, callback: grpc.requestCallback<_MessagePackage_MessageList__Output>): grpc.ClientUnaryCall;
...
export interface MessageHandlers extends grpc.UntypedServiceImplementation {
  ...
  Read: grpc.handleUnaryCall<_MessagePackage_ReadRequest__Output, _MessagePackage_MessageList>;
...
export interface MessageDefinition extends grpc.ServiceDefinition {
  ...
  Read: MethodDefinition<_MessagePackage_ReadRequest, _MessagePackage_MessageList, _MessagePackage_ReadRequest__Output, _MessagePackage_MessageList__Output>
